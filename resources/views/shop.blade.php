        ...
        <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <a href="{{route('shop.product.details',["product_slug"=>$product->slug])}}">
                                <img loading="lazy" src="{{asset('uploads/products/thumbnails')}}/{{$product->image}}" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img">                                            
                            </a>
                        </div>
                        <div class="swiper-slide">
                            @foreach (explode(",",$product->images) as $gimg)
                                <a href="{{route('shop.product.details',["product_slug"=>$product->slug])}}">
                                    <img loading="lazy" src="{{asset('uploads/products//thumbnails')}}/{{trim($gimg)}}" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                                </a>
                            @endforeach                                        
                        </div>
                    </div>
            ...
            <div class="pc__info position-relative">
                ...
                @if(Cart::instance("wishlist")->content()->Where('id',$product->id)->count()>0)
                  ...
                  @csrf 
                  @method('DELETE')
                          <button type="submit" class="pc__btn-wl position-absolute top-0 end-0 bg-transparent border-0 js-add-wishlist border-0 filled-heart" title="Remove from Wishlist">
                ...
                @else
                  ...
                  <input type="hidden" name="quantity" value="1"/>
                  <input type="hidden" name="price" value="{{$product->sale_price == '' ? $product->regular_price:$product->sale_price}}" />
                  <button type="submit" class="pc__btn-wl position-absolute top-0 end-0 bg-transparent border-0 border-0 js-add-wishlist" title="Add To Wishlist">
                          <svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <use href="#icon_heart" />
                          </svg>
                  </button>
