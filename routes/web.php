...
Route::post('/cart/store', [CartController::class, 'add_To_Cart'])->name('cart.store');
...
Route::get('/order-comfirmation',[CartController::class,'confirmation'])->name('cart.order.confirmation');
